...
export declare type FieldOutConfigWithName<TypeName extends string, FieldName extends string> = NeedsResolver<TypeName, FieldName> extends true ? NexusOutputFieldConfigWithName<TypeName, FieldName> & {
    resolve: FieldResolver<TypeName, FieldName>;
...
export declare class OutputDefinitionBlock<TypeName extends string> {
     ...
     */
    boolean<FieldName extends string>(name: FieldName, ...config: ScalarOutSpread<TypeName, FieldName>): void;
    /**
     ...
     *   from the received source type.
     */
    string<FieldName extends string>(name: FieldName, ...config: ScalarOutSpread<TypeName, FieldName>): void;
    /**
     ...
     *   from the received source type.
     */
    id<FieldName extends string>(name: FieldName, ...config: ScalarOutSpread<TypeName, FieldName>): void;
    /**
     ...
     *   from the received source type.
     */
    int<FieldName extends string>(name: FieldName, ...config: ScalarOutSpread<TypeName, FieldName>): void;
    /**
     ...
     *   from the received source type.
     */
    float<FieldName extends string>(name: FieldName, ...config: ScalarOutSpread<TypeName, FieldName>): void;
    /**
...
export declare class InputDefinitionBlock<TypeName extends string> {
    ...
    string<FieldName extends string>(fieldName: FieldName, config?: CommonInputFieldConfig<TypeName, FieldName>): void;
    int<FieldName extends string>(fieldName: FieldName, config?: CommonInputFieldConfig<TypeName, FieldName>): void;
    boolean<FieldName extends string>(fieldName: FieldName, opts?: CommonInputFieldConfig<TypeName, FieldName>): void;
    id<FieldName extends string>(fieldName: FieldName, config?: CommonInputFieldConfig<TypeName, FieldName>): void;
    float<FieldName extends string>(fieldName: FieldName, config?: CommonInputFieldConfig<TypeName, FieldName>): void;
