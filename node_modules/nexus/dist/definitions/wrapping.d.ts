...
export declare type AllNexusNamedInputTypeDefs<T extends string = any> = NexusInputObjectTypeDef<T> | NexusEnumTypeDef<T> | NexusScalarTypeDef<T> | Exclude<GraphQLInputType, GraphQLList<any> | GraphQLNonNull<any>>;
export declare type AllNexusInputTypeDefs<T extends string = any> = AllNexusNamedInputTypeDefs<T> | NexusListDef<any> | NexusNonNullDef<any> | NexusNullDef<any> | GraphQLList<any> | GraphQLNonNull<any>;
...
export declare type NexusListableTypes = AllNamedTypeDefs | NexusArgDef<any> | NexusListDef<NexusListableTypes> | NexusNonNullDef<NexusNonNullableTypes> | NexusNullDef<NexusNullableTypes> | GraphQLType | NexusMetaType;
export declare type NexusNonNullableTypes = AllNamedTypeDefs | NexusListDef<NexusListableTypes> | NexusArgDef<any> | NexusMetaType;
export declare type NexusNullableTypes = AllNamedTypeDefs | NexusListDef<NexusListableTypes> | NexusArgDef<any> | NexusMetaType;
export declare type AllNamedTypeDefs = GetGen<'allNamedTypes', string> | AllNexusNamedTypeDefs;
export declare type AllNexusNamedArgsDefs<T extends AllInputTypes = AllInputTypes> = T | NexusArgDef<T> | AllNexusNamedInputTypeDefs<T> | GraphQLInputType;
