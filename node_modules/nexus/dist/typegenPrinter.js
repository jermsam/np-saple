...
class TypegenPrinter {
    ...
    printDynamicImport() {
        ...
        const nexusSchemaImportId = (_a = this.typegenInfo.nexusSchemaImportId) !== null && _a !== void 0 ? _a : utils_1.getOwnPackage().name;
    ...
    printFeaturesConfig(exportName) {
        ...
        const unionProps = renderObject(utils_1.mapValues(abstractTypes, (val) => val !== null && val !== void 0 ? val : false));
