...
function resolveTypegenConfig(config) {
    ...
    if (outputs === undefined) {
        ...
        if (outputs.schema === true) {
            ...
            sdlFilePath = utils_1.assertAbsolutePath(outputs.schema, 'outputs.schema');
        }
        else if (outputs.schema === undefined && utils_1.isProductionStage()) {
        }
        // handle typegen configuration
        if (typeof outputs.typegen === 'string') {
            typegenFilePath = utils_1.assertAbsolutePath(outputs.typegen, 'outputs.typegen');
        }
    }
    ...
    return Object.assign(Object.assign({}, rest), { nexusSchemaImportId: utils_1.getOwnPackage().name, outputs: {
