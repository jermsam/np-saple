...
function typegenAutoConfig(options, contextType) {
    return (schema, outputPath) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const forceImports = new Set(utils_1.objValues(sourceTypeMap)
        ...
        const typeSources = yield Promise.all(options.modules.map((source) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const importPath = (path.isAbsolute(pathOrModule) ? utils_1.relativePathTo(resolvedPath, outputPath) : pathOrModule).replace(utils_1.typeScriptFileExtension, '');
