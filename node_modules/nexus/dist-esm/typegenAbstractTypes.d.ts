 ...
 */
export declare type PossibleTypes<AbstractTypeName extends string> = SourceValue<PossibleTypeNames<AbstractTypeName>>;
/**
 ...
 */
export declare type MaybeTypeDefConfigFieldIsTypeOf<TypeName extends string> = IsFeatureEnabled2<'abstractTypeStrategies', 'isTypeOf'> extends false ? {} : AbstractTypeNames<TypeName> extends never ? {
    /**
