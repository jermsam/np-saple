...
import { AllNexusArgsDefs, AllNexusNamedTypeDefs, AllNexusTypeDefs, AllNexusNamedInputTypeDefs } from './definitions/wrapping';
import { MissingType, NexusFeatures, NexusGraphQLSchema, TypingImport } from './definitions/_types';
...
export declare function getArgNamedType(argDef: AllNexusArgsDefs | string): AllNexusNamedInputTypeDefs | string;
